class MiningTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mining_type.save
        format.html { redirect_to mining_type_url(@mining_type), notice: I18n.t("miningType.msg_create") }
  ...
  def update
    respond_to do |format|
      if @mining_type.update(mining_type_params)
        format.html { redirect_to mining_type_url(@mining_type), notice: I18n.t("miningType.msg_update") }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mining_types_url, notice: I18n.t("miningType.msg_delete") }
